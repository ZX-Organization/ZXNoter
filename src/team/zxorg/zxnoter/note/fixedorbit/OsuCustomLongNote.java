...
public class OsuCustomLongNote extends LongNote{
    public int keyType;
    int hitSound;
    ...
    public OsuCustomLongNote(long timeStamp, int orbit,int keyType,int hitSound, long sustainedTime, String[] sampleSetPars) {
