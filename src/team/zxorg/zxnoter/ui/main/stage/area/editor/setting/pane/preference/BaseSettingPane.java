package team.zxorg.zxnoter.ui.main.stage.area.editor.setting.pane.preference;
...
public class BaseSettingPane {
     ...
     * 包含的设置项
     */
    public ArrayList<team.zxorg.zxnoter.ui.main.stage.area.editor.setting.item.BaseSettingItem> settingItems = new ArrayList<>();
    /**
     * 对应的设置容器物品
     */
