package team.zxorg.ui.main.stage.area.editor.base;
...
public abstract class BaseEditor extends BaseTab {
    ...
    public BaseEditor(Path path, EditorArea editorArea) {
        super(editorArea);
        this.path = path;
        ZXFileType fileType = ZXIcon.getFileType(path);
        icon.setColor(fileType.type.color);
        icon.setIconKey(fileType.iconKey);
        isEdited.set(false);
        ...
        fileName.set(String.valueOf(path.getFileName()));
