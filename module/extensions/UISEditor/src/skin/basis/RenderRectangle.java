...
public class RenderRectangle {
   ...
   /* public void setFlip(Orientation flip) {
    ...
    public double getPosX(HPos pos) {
        return switch (pos) {
            case HPos.LEFT -> left;
            case HPos.CENTER -> left + width / 2;
            case HPos.RIGHT -> right;
        };
    }
    ...
    public double getPosY(VPos pos) {
        return switch (pos) {
            case VPos.TOP -> top;
            case VPos.CENTER, VPos.BASELINE -> left + width / 2;
            case VPos.BOTTOM -> bottom;
        };
    }
    ...
    public void setX(HPos pos, double x) {
        if (setLeft(switch (pos) {
            case HPos.LEFT -> x;
            case HPos.CENTER -> x - width / 2;
            case HPos.RIGHT -> x - width;
        })) {
            right = left + width;
        }
    }
    ...
    public void setY(VPos pos, double y) {
        if (setTop(switch (pos) {
            case VPos.TOP, VPos.BASELINE -> y;
            case VPos.CENTER -> y - height / 2;
            case VPos.BOTTOM -> y - height;
        })) {
            bottom = top + height;
        }
    ...
    public void setWidth(HPos pos, double width) {
        double newLeft = left - switch (pos) {
            case HPos.LEFT -> 0;
            case HPos.CENTER -> (width - this.width) / 2;
            case HPos.RIGHT -> width - this.width;
        };
    ...
    public void setHeight(VPos pos, double height) {
        double newTop = top - switch (pos) {
            case VPos.TOP, VPos.BASELINE -> 0;
            case VPos.CENTER -> (height - this.height) / 2;
            case VPos.BOTTOM -> height - this.height;
        };
    ...
    public void scale(Pos pos, double value, Orientation orientation) {
        ...
        double scale = switch (orientation) {
            case Orientation.HORIZONTAL -> value / width;
            case Orientation.VERTICAL -> value / height;
        };
