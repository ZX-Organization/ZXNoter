package team.zxorg.ui.main.stage.area.editor.setting.item;
    ...
    protected Node initContent() {
        ...
        resourceItemListView.getSelectionModel().getSelectedItems().addListener((ListChangeListener<ResourceItem>) c -> {
            if (!isLoading) {
                ...
                /*UserPreferenceOld.setUsedBaseResources(pack.getType(), pack.getResourceFullId());
                if (pack instanceof LanguageResourcePack)
                    UserPreferenceOld.setLanguageCode(pack.getResourceId());*/
