...
public class FlexSplitPane extends SplitPane {
            ...
            while (c.next()) {
                ...
                if (c.wasRemoved()) {
                    if (c.getList().isEmpty()) {
                        ...
                        FlexSplitPane parentSplitPane = getParentFlexSplitPane();
                        //如果是根，则不精简
                        if (parentSplitPane != null) {
                            int index = parentSplitPane.getItems().indexOf(this);
                            //精简
                            //Logger.info("拆分窗格列表精简");
                            if (c.getList().getFirst() instanceof FlexTabPane tabPane) {
                                parentSplitPane.getItems().add(index, tabPane);
                            } else if (c.getList().getFirst() instanceof FlexSplitPane splitPane) {
    ...
    public FlexSplitPane createSplitPane(int index) {
        ...
        //newSplitPane.parentFlexSplitPane.set(this);
        return newSplitPane;
    }
